...
function MiniNavbar() {
  ...
  const logoElement = (
    <img src={medsyncLogo} alt="MedSync" className="h-15 w-auto" />
  );
                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Welcome to MedSync</h1>
                      <p className="text-[1.8rem] text-white/70 font-light">Hospital Dashboard</p>
                    </div>
